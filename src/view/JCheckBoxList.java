...
public class JCheckBoxList extends JList<JCheckBox> {
	...
	protected class CellRenderer implements ListCellRenderer<JCheckBox> {
		public Component getListCellRendererComponent(JList<? extends JCheckBox> list, JCheckBox value, int index,
			...
			checkbox.setBackground(isSelected ? Utils.ACCENT_COLOR : getBackground());
			checkbox.setForeground(isSelected ? Utils.BACKGROUND_COLOR : getForeground());
			...
			if (!checkbox.isSelected()) {
				...
				Map<TextAttribute, Boolean> attributes = (Map<TextAttribute, Boolean>) getFont()
					.getAttributes();
